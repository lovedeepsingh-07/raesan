...
pub async fn populate_database(
...

    {
        ...
        if app_state.db_state.is_populating() {
            ...
            app_state.db_state.begin_populate(shutdown_tx)?;
        }
    }
    ...
    let _guard = state::AppStateGuard(app_state.inner());
